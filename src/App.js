...
function App() {
  ...
  return (
    <div className='container'>
      ...
      <h2 data-aos="fade-up" className='twoFour' style={{ marginTop: height / 2 }}>What I want to achieve at Informal Systems,</h2>
      <h1 data-aos="fade-up" className='threeFive' style={{ marginTop: height / 8 }}>is to make the blockchain <i>feel</i> good.</h1>
      ...
      <div className="presentation" style={{ marginTop: height / 16 }}>
        <h2 data-aos='fade-right' className='presentationTwoThree' style={{ marginLeft: '2vw' }}>Assorted SVG Icons and Graphics</h2>
        <FileSVG/>
